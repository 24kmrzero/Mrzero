...
function setSignalPeriod(period){
  ...
  if(period==='custom'){
    ...
    const open=$('[data-open-signal-filters]');if(open)open.click();
    return
  }
  let start='',end='';
