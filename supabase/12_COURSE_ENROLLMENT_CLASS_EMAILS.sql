-- V9.16: include each current course session and online-class link in
-- free-enrollment and paid-approval emails. The existing meet_url database
-- column is retained only for backward compatibility until final Zoom integration.
...
begin
  ...
  values(new.student_id,'all_students','course','Course enrollment confirmed',
    'You are enrolled in '||coalesce(v_course,'the course')||'. Online class access is available in your Student Panel.',
